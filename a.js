...
async function menuju() {
  await swals.fire(
    "Uci!",
    "Tuy là mới quen biết nhưng rất vui khi được làm quen với em. Anh không ở gần và có những món quà ý nghĩa đối với em nhưng anh vẫn lun mong muốn những điều tốt đẹp đến với em. Anh chỉ biết dùng món quà nhỏ này tặng em tuy chỉ là 1 giao diện ko phải là 1 món quà vật chất nhưng a mong muốn rằng nó sẽ là 1 món quà ý nghĩa, 1 món quà tinh thần nào đó trong ngày đặc biệt của em. Và cuối cùng a chúc cô gái sinh nhật vui vẻ nhaaaaaaaaaa. Chúc em tất cả những điều tốt đẹp nhấtttttt nhéeeeeeee hihi^^",
    "success"
  );
  window.location = "https://thanhkun-7757.github.io/baby-happy/";
}
